...
def main():
    ...
    parser.add_argument("--ckpts_dir",
                        default='/Users/aavi/Desktop/11-777-Project/Data/WebQA_baseline_ckpts/',
                        type=str,
                        help="The output directory where checkpoints will be written.")
    parser.add_argument("--output_dir",
                        default='/Users/aavi/Desktop/11-777-Project/Model-Analysis',
                        type=str,
    ...
    # webqa dataset
    parser.add_argument('--txt_dataset_json_path', type=str, default="/Users/aavi/Desktop/11-777-Project/Data/WebQA_train_val.json")
    parser.add_argument('--img_dataset_json_path', type=str, default="/Users/aavi/Desktop/11-777-Project/Data/WebQA_train_val.json")
    ...
    parser.add_argument('--feature_folder', type=str, default="/Users/aavi/Desktop/11-777-Project/Data-Analysis")
    parser.add_argument('--image_id_map_path', type=str, default="/Users/aavi/Desktop/11-777-Project/WebQA_Baseline/misc/image_id_map_0328.pkl")
