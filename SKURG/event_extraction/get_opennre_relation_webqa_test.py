...
entities = json.load(
    open('../WebQA/WebQA_entities_dict.json', 'r'))
# file that contains the entities in WebQA

ws_lists = json.load(open('../WebQA/WebQA_facts_ws.json', 'r'))
...
if __name__ == '__main__':
    ...
    with open('../WebQA/WebQA_entities_relation_opennre.json',
              'w') as f:
        f.write(res)
    print('Write to ../WebQA/WebQA_entities_relation_opennre.json')
