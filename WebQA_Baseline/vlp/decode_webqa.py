...
import os
import sys
sys.path.append("/home/sara/WebQA_Baseline-main")
sys.path.append("/home/sara/WebQA_Baseline-main")
...
def main():
    ...
    parser.add_argument("--ckpts_dir",
                        default='/home/sara/WebQA_Baseline-main/WebQA_baseline_ckpts/qa_x101fpn',
                        type=str,
                        help="The output directory where checkpoints will be written.")
    parser.add_argument("--output_dir",
                        default='/home/sara/WebQA_Baseline-main/vlp/output/',
                        type=str,
    ...
    parser.add_argument("--model_recover_path", 
                        default="/home/sara/WebQA_Baseline-main/WebQA_Baseline_ckpts/qa_x101fpn/model.11.bin",
                        type=str,
    ...
    # webqa dataset
    parser.add_argument('--txt_dataset_json_path', type=str, default="/home/sara/WebQA_Baseline-main/WebQA_train_val.json")
    parser.add_argument('--img_dataset_json_path', type=str, default="/home/sara/WebQA_Baseline-main/WebQA_train_val.json")
    ...
    parser.add_argument('--feature_folder', type=str, default="/home/sara/WebQA_Baseline-main/feature_folder")
    parser.add_argument('--image_id_map_path', type=str, default="/home/sara/WebQA_Baseline-main/feature_folder/image_id_map_0328.pkl")
