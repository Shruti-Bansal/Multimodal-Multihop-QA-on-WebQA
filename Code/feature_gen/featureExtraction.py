...
parser.add_argument('--input_dir', type=str,default='/content/drive/MyDrive/WebQA_x101fpn/Images_avi')
parser.add_argument('--batch_size', type=int, default=4)
parser.add_argument('--threshold', type=str, default='0.0')
parser.add_argument('--output_dir', type=str, default="/content/drive/MyDrive/WebQA_x101fpn/output2")
...
if __name__ == "__main__":
    ...
    cfg.merge_from_file("/content/drive/MyDrive/WebQA_x101fpn/detectron-vlp/faster_rcnn_X_101_32x8d_FPN_3x.yaml")
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = threshold  # set threshold for this model
    cfg.MODEL.WEIGHTS = "/content/drive/MyDrive/WebQA_x101fpn/e2e_faster_rcnn_X-101-64x4d-FPN_2x-vlp-427.pkl"
