...
sys.path.append("/home/sara/WebQA_Baseline-main/BARTScore")
from bart_score import BARTScorer

bart_scorer_ParaBank = BARTScorer(device='cuda:0', checkpoint='facebook/bart-large-cnn')
bart_scorer_ParaBank.load(path='/home/sara/WebQA_Baseline-main/BARTScore/bart_score.pth') # Please change the path to bart.pth
