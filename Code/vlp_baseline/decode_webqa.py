...
#sys.path.append("/Users/aavi/Desktop/11-777-Project/WebQA_Baseline/vlp")
import logging
import glob
import json, time
import argparse
...
def main():
    ...
    parser.add_argument("--ckpts_dir",
                        default='/Users/aavi/Desktop/11-777-Project/Data/WebQA_baseline_ckpts/qa_x101fpn',
                        type=str,
                        help="The output directory where checkpoints will be written.")
    parser.add_argument("--output_dir",
                        default='/Users/aavi/Desktop/11-777-Project/Data-Analysis/',
                        type=str,
    ...
    # webqa dataset
    parser.add_argument('--txt_dataset_json_path', type=str, default="/Users/aavi/Desktop/11-777-Project/Data/WebQA_aaaa.json")
    parser.add_argument('--img_dataset_json_path', type=str, default="/Users/aavi/Desktop/11-777-Project/Data/WebQA_aaaa.json")
    ...
    parser.add_argument('--feature_folder', type=str, default="/Users/aavi/Desktop/11-777-Project/Data/feature_folder")
    parser.add_argument('--image_id_map_path', type=str, default="/Users/aavi/Desktop/11-777-Project/WebQA_Baseline/vlp/misc/image_id_map_0328.pkl")
    ...
    parser.add_argument('--use_num_samples', type=int, default=10, help="how many samples should be loaded into memory")
    parser.add_argument('--answer_provided_by', type=str, default="txt")
    ...
    if (recover_step is None) and (args.model_recover_path is None):
        ...
        if recover_step:
            ...
            model_recover = torch.load(os.path.join(args.ckpts_dir, "model.{0}.bin".format(recover_step)),map_location=torch.device('cpu'))
