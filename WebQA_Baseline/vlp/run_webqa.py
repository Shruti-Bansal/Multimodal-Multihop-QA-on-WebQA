...
def main():
    ...
    parser.add_argument("--ckpts_dir",
                        default='/home/sara/WebQA_Baseline-main/WebQA_baseline_ckpts/',
                        type=str,
                        help="The output directory where checkpoints will be written.")
    parser.add_argument("--output_dir",
                        default='/home/sara/WebQA_Baseline-main/output_retrieval/',
                        type=str,
    ...
    parser.add_argument("--model_recover_path",
                        #default=None,
                        default="/home/sara/WebQA_Baseline-main/WebQA_baseline_ckpts/model.30.bin",
                        type=str,
